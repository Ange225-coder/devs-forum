...
<html lang="fr">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../../../../public/css/displayResponsesToComments_style.css">
    </head>
    ...
    <body>
        ...
        <section>
                    ...
                    <div class="response__card">
                        <div class="response__author">
                            ...
                            <div class="response__card--marge">
                                <p class="response__author--blue"><?= $response_com['f_author']; ?></p>
                                <p class="response__author--margeTop"><?= $response_com['date_com_fr'] ?></p>
                            </div>
                        </div>

                        <p class="comment">
                            <?= $response_com['f_comment'] ?>
                        </p>
                    </div>
            ...
            <form method="post" action="../../../../backend/router/router.php?action=setNewCommentCtrl&amp;idPost=<?= $getting_post['id']; ?>">
                ...
                <div class="form__btn">
                    <button type="submit"><i class="bi-chat-left-dots"></i>Commentez</button>
                </div>
            </form>
        </section>
